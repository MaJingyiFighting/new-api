	...
	Rules: []ChannelAffinityRule{
		{
			...
			PathRegex:  []string{"/v1/responses", "/responses", "/backend-api/codex/responses"},
			KeySources: []ChannelAffinityKeySource{
				{Type: "gjson", Path: "prompt_cache_key"},
				{Type: "gjson", Path: "metadata.user_id"},
				{Type: "request_header", Key: "Session_id"},
				{Type: "request_header", Key: "X-Codex-Turn-Metadata"},
				{Type: "request_header", Key: "Originator"},
			},
			ValueRegex:            "",
			TTLSeconds:            0,
		...
		{
			Name:       "domestic llm trace",
			ModelRegex: []string{"^MiniMax.*$", "^minimax.*$", "^mimo.*$", "^glm.*$", "^GLM.*$", "^kimi.*$", "^moonshot.*$", "^google/.*$", "^gemini.*$"},
			PathRegex:  []string{"/v1/responses", "/responses", "/backend-api/codex/responses"},
			KeySources: []ChannelAffinityKeySource{
				{Type: "gjson", Path: "prompt_cache_key"},
				{Type: "gjson", Path: "metadata.user_id"},
